...
public final class FindMeetingQueryTest {
  ...
  public void everyAttendeeAndOptionalAttendeeIsConsidered() {
    // Have each required attendee have different events. An optional attendee has a whole-day event.
    //
    // Events  :       |--A--|     |--B--|
    //         : |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  public void everyAttendeeAndOptionalAttendeeAttendanceIsConsidered() {
    // Have each required attendee have different events.
    // An optional attendee is booked only for a single 30 minute event.
    //
    // Events  :       |--A--|     |--B--|
    //         :             |--C--|
    // Day     : |-----------------------------|
  ...
  public void justEnoughRoomWithOptionalAttendee() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    // Optional attendee B should be ignored, because considering it would create too small of a meeting.
    //
    // Events  : |--A--|     |----A----|
    //         :       |-B|
    // Day     : |---------------------|
  ...
  public void onlyOptionalAttendeesConsidered() {
    ...
    // Should return the gaps in both of their schedules.
    //
    // Events  : |--A--|     |----A----|
    //         :             |-B--|         |--B--| 
    // Day     : |--------------------------------|
  ...
  @Test
  public void onlyOptionalAttendeesWithoutGapsConsidered() {
    // Two optional attendees without gaps in their schedules.
    // No TimeRanges should be returned
    //
    // Events  : |----------A----------|
    //         : |----------B----------|
    // Day     : |---------------------|
